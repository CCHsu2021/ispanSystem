...
namespace MSITTeam1.ViewModels
{
    public class TJobVacanciesViewModel
    {
        ...
        [DisplayName("薪水")]
        public int? FSalary { get { return this.jobV.FSalary; } set { jobV.FSalary= value; } }
        [DisplayName("工作型態")]
        ...
        [DisplayName("最後修改時間")]
        public string FModifyTime { get { return this.jobV.FModifyTime; } set { jobV.FModifyTime = value; } }
        [DisplayName("公司名稱")]
